...
void DispMenuConfigGameGoodUseTimeUp(void)
{
	...
	*/	
	...
	DisplaySuccessFailure(((GameGoodUseTimeStartBackup == RamSetParameters.GameGoodUseTimeStart) && (GameGoodUseTimeStartBackup == RamSetParameters.GameGoodUseTimeEnd)) ? 1:0);
...
void DispMenuConfigGameBadUseTimeUp(void)
{
	...
	*/	
	...
	DisplaySuccessFailure(((GameBadUseTimeStartBackup == RamSetParameters.GameBadUseTimeStart) && (GameBadUseTimeStartBackup == RamSetParameters.GameBadUseTimeEnd)) ? 1:0);
