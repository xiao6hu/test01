    ...
    switch(Item){
        case 0:
		{
			...
			*/
			...
			Jump2Menu(MusicStatusSetIndex,FlashMode_AutoInit);	
        ...
        case 1:
		{
			...
			Jump2Menu(LightsStatusSetIndex,FlashMode_AutoInit);	
            break;
        }
		...
		case 2:
		{
			...
			//PUSH();
			Jump2Menu(GameModeSelectIndex,FlashMode_ManualInit);	
			//Jump2Menu(SelfMenuIndex,FlashMode_NoAction);
			break;
		}
		...
		case 3:
		{
			...
			//PUSH();
			Jump2Menu(GameSelectIndex,FlashMode_ManualInit);	
			//Jump2Menu(SelfMenuIndex,FlashMode_NoAction);
			break;
		}
		...
		case 4:
		{
			...
			PUSH();
			Jump2Menu(CleanRankingDataIndex,FlashMode_AutoInit);	
			//Jump2Menu(SelfMenuIndex,FlashMode_NoAction);
			break;
		}
		...
		case 5:
		{
			...
			PUSH();
			Jump2Menu(FactorySetIndex,FlashMode_AutoInit);	
			//Jump2Menu(SelfMenuIndex,FlashMode_NoAction);
			break;
		}
		...
		case 6:
		{
			...
			PUSH();
			Jump2Menu(AboutIndex,FlashMode_AutoInit);	
			//Jump2Menu(SelfMenuIndex,FlashMode_NoAction);
			break;
		}
