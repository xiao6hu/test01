 ...
 * Project:      Ethernet Media Access (MAC) Driver for STM32F2xx
 * --------------------------------------------------------------------------
 ...
 */
 ...
 /*! \page stm32f2_emac CMSIS-Driver Ethernet MAC Setup
