 ...
 * Project:      I2C Driver for ST STM32F2xx
 * --------------------------------------------------------------------------
...
/*! \page stm32f2_i2c CMSIS-Driver I2C Setup 
...
:-------------------|:------------------|:-------------
I2C Mode            | I2C1: <b>I2C</b>  | I2C1: <b>I2C</b>
SCL pin             | PB8               | PB6
SDA pin             | PB9               | PB9
...
static int32_t I2C_PowerControl (ARM_POWER_STATE state, I2C_RESOURCES *i2c) {
  ...
  switch (state) {
    case ARM_POWER_OFF:
      /* Enable I2C clock */
      if (i2c->reg == I2C1)      { __I2C1_CLK_ENABLE(); }
      #if (defined (I2C2) && (RTE_I2C2 != 0))
      else if (i2c->reg == I2C2) { __I2C2_CLK_ENABLE(); }
      #endif
      #if (defined (I2C3) && (RTE_I2C3 != 0))
      else if (i2c->reg == I2C3) { __I2C3_CLK_ENABLE(); }
      #endif
      ...
      i2c->reg->CR1 = 0;
        ...
        #endif
        #if (defined (I2C3) && (RTE_I2C3 != 0))
        else if (i2c->reg == I2C3) { __I2C3_CLK_DISABLE(); }
        #endif
        else { return ARM_DRIVER_ERROR; }
      #else
