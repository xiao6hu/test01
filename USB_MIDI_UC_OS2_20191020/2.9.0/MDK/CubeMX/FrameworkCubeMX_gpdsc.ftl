...
[#assign adc=false can=false i2c=false i2s=false sdio=false spi=false tim=false ]
[#assign uart=false usart=false irda=false smartcard=false pcd=false hcd=false]
[#assign nor=false nand=false pccard=false sram=false]
  ...
  <generators>
    <generator id="STM32CubeMX" Gvendor="STMicroelectronics" Gtool="STM32CubeMX" Gversion="4.10.0">
      ...
      <project_files>
        ...
        <file category="header" name="STCubeGenerated/Inc/stm32f2xx_it.h"/>
        <file category="source" name="STCubeGenerated/Src/stm32f2xx_it.c"/>
      </project_files>
    </generator>
  </generators>
  <taxonomy>
  ...
  <components>
    <component generator="STM32CubeMX" Cvendor="Keil" Cclass="Device" Cgroup="STM32Cube Framework" Csub="STM32CubeMX" Cversion="1.0.0" condition="STCubeMX">
      ...
      <files>
        ...
        <file category="header" name="STCubeGenerated/Inc/stm32f2xx_hal_conf.h"/>
        <file category="source" name="STCubeGenerated/Src/stm32f2xx_hal_msp.c"/>
      </files>
    </component>
  </components>
</package>
